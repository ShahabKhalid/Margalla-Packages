...
?>
    ...
    <div class="row">
        ...
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span style="font-size:24px;font-weight:bold;">OPENING BALANCE</span>
        </div>
        <div class="col-sm-5" style="border:1px solid black;"><span
                    style="font-size:24px;font-weight:bold;"><?php if (intval($month) > 1) {
                $openBal = closingBalance($con, intval($month) - 1, $year);
            } else {
                $openBal = closingBalance($con, 12, intval($year) - 1);
            }
            echo "Rs. " . number_format($openBal); ?></div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10 text-left" style="border:1px solid black;"><span style="font-size:24px;font-weight:bold;">SALES</span>
        </div>
        <div class="col-sm-1"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                    style="font-size:18px;">Customer's Invoice</span></div>
        <?php
        ...
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;"><?php echo "Rs. " . number_format(round($custInvTot, 2, PHP_ROUND_HALF_EVEN)); ?></span>
        </div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10 text-left" style="border:1px solid black;"><span style="font-size:24px;font-weight:bold;">PURCHASES</span>
        </div>
        <div class="col-sm-1"></div>
    </div>
    <?php
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                    style="font-size:18px;">Factory Bills</span></div>
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;"><?php echo "Rs. " . number_format($fac_bill); ?></span></div>
        <div class="col-sm-1"></div>
    </div>
    <?php
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span style="font-size:18px;">Block Bills</span>
        </div>
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;"><?php echo "Rs. " . number_format($block_bill); ?></span></div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10 text-left" style="border:1px solid black;"><span style="font-size:24px;font-weight:bold;">EXPENCES</span>
        </div>
        <div class="col-sm-1"></div>
    </div>
    <?php
    ...
    while ($data = mysqli_fetch_array($run)) {
        ...
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                        style="font-size:18px;"><?php echo $data['name']; ?></span></div>
            <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                        style="font-size:18px;"><?php echo "Rs." . number_format(floatval($data['total']));
                    $exp_tot += floatval($data['total']); ?></span></div>
            <div class="col-sm-1"></div>
        </div>
        <?php
    }
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span style="font-size:18px;font-weight:bold;">Total Expence</span>
        </div>
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;font-weight:bold;">Rs. <?php echo number_format($exp_tot); ?></span></div>
        <div class="col-sm-1"></div>
    </div>
    <?php
...
//echo $month." - ".date("m"). " ".strcmp($month,date("m"));
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span style="font-size:18px;font-weight:bold;">Salaries</span>
        </div>
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;">Rs. <?php echo number_format($tot_sal_all); ?></span></div>
        <div class="col-sm-1"></div>
    </div>
    <?php
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                    style="font-size:18px;"><b>Profit Earned</b> (Month's Invoices - Bills - Expences - Salaries)</span>
        </div>
        <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                    style="font-size:18px;">Rs. <?php echo number_format($profitEarned); ?></span></div>
        <div class="col-sm-1"></div>
    </div>
    <div id="tableDIV">
        <?php
        ...
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                        style="font-size:18px;font-weight:bold;">Van Profit</span></div>
            <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                        style="font-size:18px;">Rs. <?php echo number_format($vanProfit); ?></span></div>
            <div class="col-sm-1"></div>
        </div>
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                        style="font-size:18px;font-weight:bold;">Total Profit</span></div>
            <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                        style="font-size:18px;font-weight:bold;">Rs. <?php $finTotal = floatval($profitEarned) + floatval($vanProfit);
                    echo number_format($finTotal); ?></span></div>
            <div class="col-sm-1"></div>
        </div>
        <?php
        ...
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-2 text-left" style="border:1px solid black;"><span
                        style="font-size:18px;font-weight:bold;">Received Payments</span></div>
            <div class="col-sm-3 text-center" style="border:1px solid black;"><span
                        style="font-size:18px;">Rs. <?php echo number_format($recd); ?></span></div>
            <div class="col-sm-2 text-left" style="border:1px solid black;"><span
                        style="font-size:18px;font-weight:bold;">Receivable</span></div>
            <div class="col-sm-3 text-center" style="border:1px solid black;"><span
        ...
        <h3>Payables
            <h3>
                ...
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;">Block</span></div>
                    <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;">Rs. <?php $total_balance = $total_balance * -1;
                            echo number_format($total_balance);
                            $TOTAL_PAYABLE += $total_balance; ?></span></div>
                ...
                <div id="payableArea">
                    ...
                    while ($data = mysqli_fetch_array($run)) {
                        ...
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                                        style="font-size:18px;font-weight:bold;"><input type='text'
                                                                                        value='<?php echo $name; ?>'
                                                                                        id='otherspayable<?php echo $payableCount; ?>'
                                                                                        placeholder="Others payable name"
                                                                                        style="width:100%;position:relative;top:-1px;"/></span>
                            </div>
                            <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                                        style="font-size:18px;font-weight:bold;"><input style="text-align:center;"
                                                                                        type='text'
                                                                                        value='<?php echo $amount; ?>'
                                                                                        id='otherspayable<?php echo $payableCount; ?>Amount'
                                                                                        placeholder="Others payable amount"
                                                                                        style="width:100%;position:relative;top:-1px;"/></span>
                            </div>
                            <div class="col-sm-1"></div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;">Total Payables</span></div>
                    <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;"><?php echo number_format($TOTAL_PAYABLE); ?></span>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-5 text-left" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;">Opening Balance</span></div>
                    <div class="col-sm-5 text-center" style="border:1px solid black;"><span
                                style="font-size:18px;font-weight:bold;"><?php echo number_format($openBal); ?></span>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="row">
                ...
                <br>
                <button onclick="savePayable()">Save All</button>
                <br><br>
                <span id="not"></span>
                <a href="javascript:void()" onclick="return exportPS('<?php echo $month; ?>','<?php echo $year; ?>')">Export
                    to excel</a>
                <br>
    </div>
</div>
