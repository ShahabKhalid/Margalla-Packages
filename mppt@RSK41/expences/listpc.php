...
<div class="row">
	...
	<div class="col-sm-3"><input type="text" name="id" id="filter_id" placeholder="ID" onchange="updatePettyCashList(orderByWas)"></div>
...
<div class="row">
	...
	<div class="col-sm-3"><input type="text" name="contact" id="filter_desc" placeholder="Description" onchange="updatePettyCashList(orderByWas)"></div>
	<div class="col-sm-1"><span style="font-size:20px;">Amount</span></div>
	<div class="col-sm-3"><input type="text" name="addr" id="filter_amount" placeholder="Amount" onchange="updatePettyCashList(orderByWas)"></div>
	<div class="col-sm-2"></div>
</div>
</div>
<div class="row" id="r2" style="background-color:rgba(0,0,0,0.7);color:white;">
<div class="col-md-1"><b>Serial</b></div>
<div class="col-md-1" onclick="updatePettyCashList('id')"><b>ID</b></div>
<div class="col-md-3" onclick="updatePettyCashList('description')"><b>Amount</b></div>
<div class="col-md-6" onclick="updatePettyCashList('amount')"><b>Description</b></div>
...
function updatePettyCashList(orderBy)
{
    ...
    xhttp.open("POST", "do.php?action=updatePettyCashTable", true);
