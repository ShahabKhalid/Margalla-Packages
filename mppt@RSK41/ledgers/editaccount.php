...
<div class="row" id="r1"><div class="col-md-2"></div><div class="col-md-3"><label>Name</label></div><div class="col-md-4">
<input maxlength="24" id="nameEle" type="text" name="custName" placeholder="John Doe" value="<?php echo $data['name']; ?>"></div><div class="col-md-3"></div></div>
...
<div class="row" id="r1"><div class="col-md-6"><input onclick="updateAccount()" type="button" name="submit" value="Update"></div><div class="col-md-6"><input onclick="deleteAccount()" type="button" name="submit" value="Delete"></div></div><br>
...
function updateAccount()
{
    ...
    if (xhttp.readyState == 4 && xhttp.status == 200) {
        ...
        else if(xhttp.responseText === "1")
        {
            ...
            $("#not").css({color:'green'});
            $("#not").slideDown();
            pageLoad("ledgers/accounts.php");
        }
    }};

    xhttp.open("POST", "do.php?action=updateLaccount", true);
...
function deleteAccount()
{
    ...
    xhttp.open("POST", "do.php?action=deleteLaccount", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
