...
<div class="col-md-2" onclick="updateExpenceList('id')"><b>ID</b></div>
<div class="col-md-4" onclick="updateExpenceList('name')"><b>Account</b></div>
<div class="col-md-3" onclick="updateExpenceList('description')"><b>Amount</b></div>
...
function updatePettyCashList(orderBy)
{
    ...
    xhttp.open("POST", "do.php?action=updateLPaymentTable", true);
